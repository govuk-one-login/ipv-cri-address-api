...
const dynamoDbClientMock = vi.mocked(DynamoDbClient);
...
describe("get-addresses-handler", () => {
    ...
    beforeEach(() => {
        ...
        loggerSpy = vi.spyOn(mockedLogger.prototype, "error");
    });
    ...
    it("handles standard Error thrown by service and returns status code 500", async () => {
        ...
        vi.spyOn(addressService, "getAddressesBySessionId").mockRejectedValueOnce(dynamoError);
    ...
    it("handles non-standard error with custom status code and message", async () => {
        ...
        vi.spyOn(addressService, "getAddressesBySessionId").mockRejectedValueOnce(customError);
    ...
    it("handles an unknown error and returns default 500 Internal Server Error", async () => {
        ...
        vi.spyOn(addressService, "getAddressesBySessionId").mockRejectedValueOnce(unknownError);
    ...
    describe("with context", () => {
        it("returns 200 with context when getAddressesBySessionId resolves successfully", async () => {
            ...
            vi.spyOn(addressService, "getAddressesBySessionId").mockResolvedValueOnce(mockResult);
