...
//                    capturedDimension);
//            assertEquals(HttpStatusCode.BAD_REQUEST, responseEvent.getStatusCode());
//            assertEquals("\"Failed to parse postcode from request body\"",
// responseEvent.getBody());
//        }
//
//        @Test
...
//            assertEquals(
//                    "{\"error_description\":\"Access denied by resource owner or authorization
// server - Session not found\",\"error\":\"access_denied\"}",
//                    responseEvent.getBody());
//        }
//
//        @Test
...
//            assertEquals(
//                    "{\"error_description\":\"Access denied by resource owner or authorization
// server - Session expired\",\"error\":\"access_denied\"}",
//                    responseEvent.getBody());
//        }
//
//        @Test
...
//                    dimension);
//            assertEquals("\"Error sending request for postcode lookup\"",
// responseEvent.getBody());
//        }
//    }
//
